    ...
    <main>
      ...
      <section className="h-screen w-full" style={{
        ...
        <div className="h-full w-full flex">
          <div className="w-8/12 #bg-pink-200">
            
          </div>
          <div className="w-4/12 #bg-yellow-200 pl-10 pr-2">
            ...
            <div className="px-4 h-[60%]">
              <div className="bg-[#1b1a1a] text-white gap-x-3 justify-around p-5 lg:grid-cols-2 grid rounded-xl border-2 border-[#4c4c4c] h-full">
                {/* Product */}
