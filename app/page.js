...
export default function Home() {
    ...
    return (
      <div className="relative">
        <span
          ...
          className="font-medium text-gray-600 w-full block title text-xl"
        >
          {children}
        </span>
      </div>
  ...
  function ProductCard() {
    return (
      <div className="flex group flex-col h-[285px] gap-y-3 p-3 border-x border-b border-zinc-100 hover:bg-zinc-100/30 transition hover:shadow-[0px_0px_10px_0px_rgba(0,0,0,0.3)]">
        ...
        <div className="flex justify-between">
          <div className="flex flex-col">
            <span className="text-sm text-[#768b9e] line-through">
              ₹1250.00
            </span>
  ...
  function HorizontalProductCard() {
    return (
      <div className="flex w-full hover:bg-zinc-50 relative h-[90px] md:my-5 my-2">
        ...
        <div className="w-[70%] flex justify-between flex-col py-2">
          <div>
            <span
              style={{
                color: "#0062bd",
          ...
          <div className="px-2">
            ...
            <div><span className="text-base text-zinc-800">₹9,000</span></div>
          </div>
        </div>
      </div>
    );
    ...
    <main>
          ...
          <div className="h-[60%] relative pt-10 w-full md:flex">
              ...
              <div className="my-auto w-full px-5">
                <div>
                  <h1
                    ...
                    className="font-light md:text-[54px] text-[48px]"
                  >
                    OVER <strong className="font-bold">1 MILION</strong>
                  </h1>
                  <h2 className="font-semibold text-[12px] w-full text-center md:w-auto md:text-[14.5px] tracking-tight">
                ...
                <div className="md:w-[80%] py-7">
                  <div className="flex h-14">
                    ...
                    <button className="rounded-r-full hover:bg-black group flex w-20 transition duration-500 bg-primary justify-center">
                      ...
                      >
                        <path
                          className="group-hover:fill-white fill-gray-800 transition"
                          fillRule="evenodd"
                          clipRule="evenodd"
            ...
            <div className="md:w-[37%] w-full md:pl-10 md:pr-2">
              <div className="flex gap-x-3 px-3 py-5">
                ...
                <span
                  className={cn(
                    "text-white font-bold text-xl text-center my-auto",
                    roboto.className
                  )}
                >
                  Hot Products Today
              ...
              <div className="px-4 h-full">
                <div className="bg-[#1b1a1a] text-white gap-x-3 justify-around p-5 grid-cols-2 grid rounded-xl border-2 border-[#4c4c4c] h-full">
                  ...
                  <div className="flex flex-col gap-y-3 border-r pr-2 border-[#4c4c4c]">
                    <span className="text-xs text-[#4c4c4c] font-medium">
                      Smartphones
                    </span>
                    <span
                      style={{
        ...
        <div className="md:flex w-full h-full md:px-20 lg:px-28">
          <div className="md:w-3/12 hidden md:block h-full px-5">
            <div className="pb-5 pt-3">
              <div className="relative">
                <span
                  ...
                  className="font-bold text-gray-600 w-full block title text-[18px]"
                >
                  Assortment
                </span>
              </div>
            ...
            <ul id="collection-links" className="text-sm">
              <ul>
                <li className="font-semibold py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer px-1 hover:font-semibold">
                  Value of the Day
                </li>
                <li className="font-semibold py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                  <a>Top 100 Offers</a>
                </li>
                <li className="font-semibold py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                  <a>New Arrivals</a>
              ...
              <li className="relative py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                <a>Computer & Accessories</a>
              </li>
              <li className="relative py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                <a>Camera, Audio & Video</a>
              </li>
              <li className="relative py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                <a>Mobile & Tablets</a>
              </li>
              <li className="relative py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                <a>Movies, Music & Video Games</a>
              </li>
              <li className="relative py-1.5 hover:bg-zinc-200/50 transition lg:cursor-pointer border-t px-1 hover:font-semibold">
                <a>Watches & Eyewear</a>
              </li>
      ...
      <section className="lg:px-28 px-3 md:px-10 py-10">
        <div className="grid lg:grid-cols-4 gap-y-3 md:grid-cols-2 gap-x-6">
          ...
          <div>
            <TitleBox>Top Selling Products</TitleBox>
            <div className="grid grid-rows-3 gap-y-6">
              <HorizontalProductCard />
              <HorizontalProductCard />
              <HorizontalProductCard />
          ...
          <div>
            <TitleBox>On-sale Products</TitleBox>
            <div className="grid grid-rows-3 gap-y-6">
              <HorizontalProductCard />
              <HorizontalProductCard />
              <HorizontalProductCard />
          ...
          <div className="my-auto">
            <div className="flex h-10">
              <input
                ...
                className="h-full w-full text-sm focus:outline-none rounded-l-full"
              />
              <button className="rounded-r-full text-white hover:bg-white group flex w-20 transition duration-500 bg-black justify-center">
                <span className="my-auto group-hover:text-black px-4">SignUp</span>
              </button>
            </div>
          </div>
        </div>
