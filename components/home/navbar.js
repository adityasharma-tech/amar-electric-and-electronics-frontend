...
export default function Navbar() {
  return (
    <React.Fragment>
      ...
      <header className="py-[20px] hidden md:flex text-white bg-[#151515] flex-row px-5 md:px-24 justify-between">
        <div>
          <Image
            alt="logo"
            width={40}
            height={40}
            src={siteConfig.logo._round}
          />
        </div>
            ...
            <Tooltip>
              <TooltipTrigger>
                <span className="flex my-auto gap-x-1">
                  ...
                  <span className="text-base my-auto font-bold">$0.00</span>
                </span>
              </TooltipTrigger>
              <TooltipContent>
                <p>Cart</p>
      ...
      <header className="py-2 flex bg-primary md:hidden text-white flex-row px-5 justify-between">
        <div>
          <Image
            alt="logo"
            width={40}
